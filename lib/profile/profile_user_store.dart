...
class ProfileUserStore extends StatefulWidget {
  ...
  @override
  State<ProfileUserStore> createState() => _ProfileUserStoreState();
}

class _ProfileUserStoreState extends State<ProfileUserStore> {
