...
import 'package:flutter_project_business/controller/load_catalog_items.dart';
...
class ShowCatalogGeneral extends StatefulWidget {
  final String userId;
  final String dadosUser;
  const ShowCatalogGeneral(
      {super.key, required this.dadosUser, required this.userId});

  @override
  State<ShowCatalogGeneral> createState() => _ShowCatalogGeneralState();
}

class _ShowCatalogGeneralState extends State<ShowCatalogGeneral> {
              ...
              body: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    Padding(
                      padding:
                          const EdgeInsets.only(left: 15, right: 12, top: 5),
                      child: Row(
                        children: [
                          const Text(
                            'Novidades',
